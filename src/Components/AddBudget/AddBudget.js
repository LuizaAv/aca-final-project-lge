      ...
      <div>
        <Dialog open={open} onClose={handleClose}>
          ...
          <DialogContent style={style.sizes}>
            ...
            <div>
              <label>Name</label>
              <TextField style={style.textfield} onChange={handleNameChange}/>
            </div>
            <div>
              <label>Amount</label>
              <TextField style={style.textfield} onChange={handleAmountChange}/>
            </div>
            <Button variant="outlined" style={style.submitButton} onClick={handleAddingCategory}>
            + Add
          </Button>
          </DialogContent>
        </Dialog>
